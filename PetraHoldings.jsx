...
export default function PetraHoldings() {
  ...
  return (
    <>
      ...
      {page === "contact" && (
        <div style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "var(--ink)", padding: "140px 5vw 80px" }}>
          <div style={{ textAlign: "center" }}>
            <div className="stag" style={{ justifyContent: "center" }}>Get in Touch</div>
            <h2 className="sh">Request a Proposal</h2>
            <div className="sdiv" style={{ margin: "1.4rem auto" }} />
            <p className="ssub" style={{ margin: "0 auto 2rem", textAlign: "center" }}>
              Our estimating team will respond within 48 hours with a tailored proposal.
            </p>
            <button className="btn-g" onClick={() => go("home")}>← Back to Site</button>
          </div>
        </div>
      )}
